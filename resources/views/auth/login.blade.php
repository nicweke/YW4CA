        ...
        <div class="forny-inner">
            ...
            @endif
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mt-10" style="position: relative; top:25px;">
                ...
                <div class="right-pane">
                    <div class="text-center" style="width: 300px">
                        <div class="mb-10 forny-logo" style="position: relative;bottom:70px;">
                            <a href="{{route('home')}}">
                                <img src="{{asset('assets/img/logo/5.png')}}" alt="" style="height: 70%; width:70%;">
                            </a>
                        </div>
                        <!--<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="296"
                            height="264" viewBox="0 0 296 264">
                            <defs>
                                <style>
                                    .a {
                                        opacity: 0.8;
                        ...
                        <img src="{{ asset('assets/img/home/14.png')}}" alt="" style="width: 130%; position: relative; right:25px;">
                        <div class="mt-10">
