            ...
            @endif
                ...
                <div class="right-pane">
                    <div class="text-center" style="width: 300px">
                        <div class="mb-10 forny-logo" style="position: relative; bottom:20px;">
                        <a href="{{route('home')}}">
                    ...
                    <img src="{{ asset('assets/img/home/16.png')}}" alt="" style="width: 130%; position: relative; right:25px;">
                        <div class="mt-10">
